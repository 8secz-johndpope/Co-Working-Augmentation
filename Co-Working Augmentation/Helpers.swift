...
class AAButton : UIControl {
    ...
    func configureButton (forConfiguration configuration : AAButtonConfiguration, completion: (() -> Void)?) {
        
        
        let animator = UIViewPropertyAnimator(duration: 0, timingParameters: UISpringTimingParameters(dampingRatio: 0.9, frequencyResponse: 0.5))
